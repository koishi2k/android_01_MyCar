...
public class myMapTest extends Fragment
        implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    //region constants
    private static final String kTAG = myMapTest.class.getSimpleName();
    //endregion
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_my_map_test, container, false);
        ...
        myMapFragment = (SupportMapFragment) myContainer.getChildFragmentManager().findFragmentById(R.id.map);
